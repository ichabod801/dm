...
DRY = {
	...
	'confirm-off': 'The {} setting is off.',
	'confirm-on': 'The {} setting is on.',
	...
	'confirm-pc-rem': 'The PC named {} has been removed.',
	...
	'error-no-combat': 'There is no current initiative order.',
	'error-on-off': 'Invalid setting for {}.',
	'error-option': 'Invalid option name: {!r}.',
	'error-pc': 'There is no player character named {}.',
	'error-pc-arg': 'Invalid argument to the pc command: {!r}.',
	...
	'pc-ac': 'What is their armor class? ',
	'pc-abilities': 'What are their ability scores (comma separated)? ',
	'pc-hp': 'How many hit points do they have? ',
	'pc-init': 'What is their initiative bonus? ',
	'pc-saves': 'What saves are they proficient in (comma separated)? ',
	'pc-skills': 'What skills are they proficient in (comma separated)? ',
	'prompt': 'EGOR >> ',
	'removed-alarm': 'The alarm has been removed.',
	'set-init': 'What is the initiative for {}? ',
	'set-init-bonus': 'What is the initiative bonus for {} (hit enter for typo in creature name)? ',
...
EGOR = {
	...
	'confirm-off': 'I moved the {} lever to off, master.',
	'confirm-on': 'I moved the {} lever to on, master.',
	...
	'confirm-pc-rem': '{} sleeps with the sahaugin, master.',
	...
	'error-no-combat': 'But master, no one is fighting, kung fu or otherwise.',
	'error-on-off': 'The {} lever refuses to be set to that, master.',
	'error-option': 'I do not know any options named {}, master.',
	'error-pc': 'I do not know of an enemy named {}, master.',
	'error-pc-arg': 'But, master! Doing that to an enemy is not part of my job description.',
	...
	'pc-ac': "What is the enemy's armor class? ",
	'pc-abilities': "What are the enemy's ability scores (comma separated)? ",
	'pc-hp': "How many hit points does the enemy have? ",
	'pc-init': "What is the enemy's initiative bonus? ",
	'pc-saves': "What saves is the enemy's proficient in (comma separated)? ",
	'pc-skills': "What skills is the enemy's proficient in (comma separated)? ",
	'prompt': 'Yes, master? ',
	'removed-alarm': '\nIt squeaked when I killed it, master.',
	'set-init': 'Master, what initiative should I use for {}? ',
	'set-init-bonus': 'Master, what is the init bonus for {} (or nothing for the wrong creature)? ',
